...
const industries = [
    ...
    { name: "Track Mounted Screen - 4 Deck", link: "/products/mobileseries/tms4deck" },
    ...
    <>
      ...
      <section className="py-20 px-6 bg-gray-100 text-black flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2">
         ...
         Hefty electrical mobile screens’ robust design, versatility and easily adjustable strokes enables screening for multiple applications.
          </p>
       ...
       <section className="bg-[#ec6b24] text-white px-8 py-16">
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6">
                ...
                <div className="border border-gray-700 p-6">
                  <h3 className="text-xl text-white font-semibold mb-2">Heavy duty dual deck Vibrating Grid (optional) & Tipping Grid available for different applications like iron ore, river bed materials etc.</h3>
                ...
                <div className="border border-gray-700 p-6">
                  <h3 className="text-xl text-white font-semibold mb-2">Robust heavy duty chasis with catwalk access on both sides of the machine.</h3>
      ...
      <h2 className="text-3xl text-blue-900 hover:text-[#ec6b24] font-bold mb-10">
        Types of Track Mounted Screens
      </h2>
