    ...
    <div className="min-h-screen bg-white relative overflow-hidden text-black">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-16 relative z-10">
        ...
        <motion.h1
          ...
          className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 text-[#ec6b24] text-center sm:text-left"
        >
          The Science of Perfect Aggregates – How Hefty Machines Deliver
          Unmatched Quality
        </motion.h1>
