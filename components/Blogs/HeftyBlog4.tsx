    ...
    <div className="min-h-screen bg-white relative overflow-hidden text-black">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-16 relative z-10">
        ...
        <motion.h1
          ...
          className="font-serif text-2xl sm:text-3xl md:text-4xl font-extrabold mb-6 sm:mb-8 text-[#ec6b24] text-center sm:text-left"
        >
          Safety and Sustainability – How Hefty Leads in Responsible Machinery
          Design
        </motion.h1>
        ...
        {[
          ...
          >
            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-3 text-[#ec6b24]">
              {sec.title}
            </h2>
