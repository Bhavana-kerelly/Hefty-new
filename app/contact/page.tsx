  ...
  return (
    <>
      ...
      <div className="w-[1280px] h-[700px] relative">
        <Image
          src="/contact1.jpg" // replace with your banner image path
          alt="Contact Banner"
          fill
      ...
      <div className="relative min-h-screen text-black py-12 px-6 md:px-12 overflow-hidden bg-gray-100">
        ...
        >
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <p className=" text-gray-500 text-sm pt-15 pb-7">
            ...
            <div className="space-y-4 text-gray-200 text-sm">
              ...
              <div className="flex items-start space-x-3 pb-5">
...
>
  ...
  <form className="space-y-4">
    ...
    >
      <label className="block text-sm font-medium text-gray-200 mb-1">Select Product</label>
      <select className="w-full mt-1 border border-gray-500 bg-transparent text-gray-500 rounded-md p-2 text-sm focus:ring-2 focus:ring-blue-400 focus:outline-none transition">
